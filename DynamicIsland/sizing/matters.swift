...
/// Small vertical extension applied to the expanded surface. The top edge
/// stays anchored to the menu bar, so this lengthens the panel downward without
/// changing its horizontal footprint.
let openNotchVerticalExtension: CGFloat = 10
